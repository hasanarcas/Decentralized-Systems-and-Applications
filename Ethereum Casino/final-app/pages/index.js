    ...
    return (
      <div className="container">
        ...
        <div className="jumbotron">
          <h1 className="display-4 text-center mt-5">Welcome to the Ethereum Casino!</h1>
          <p className="lead text-center mt-4">This is a simple web application that will help you to gamble by using the Ethereum Blockchain technology.</p>
          <hr className="my-4" />
